...
public class MedicoConsultasPendentesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medico_consultas_pendentes);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<Consulta> adapter = new ArrayAdapter<Consulta>(MedicoConsultasPendentesActivity.this, android.R.layout.simple_list_item_1, consultas);
                listView.setAdapter(adapter);

                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapter, View v, int position, long id) {
                        Consulta selItem = (Consulta) consultas.get(position);
                        Intent intent = new Intent(MedicoConsultasPendentesActivity.this, RealizarConsultaActity.class);
